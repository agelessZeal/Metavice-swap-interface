  ...
  return (
    <Fragment>
      <Head>
        ...
        />
        <title key="title">Metavice</title>
        ...
        <meta name="application-name" content="Metavice App" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
        <meta name="apple-mobile-web-app-title" content="Metavice App" />
        ...
        <meta key="twitter:title" name="twitter:title" content="Metavice App" />
        <meta key="twitter:url" name="twitter:url" content="https://app.sushi.com" />
        <meta
          key="twitter:description"
          name="twitter:description"
          content="Be a DeFi Chef with Metavice. Swap, earn, stack yields, lend, borrow, leverage all on one decentralized, community driven platform. Welcome home to DeFi"
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.sushi.com/icons/icon-192x192.png" />
        <meta key="twitter:creator" name="twitter:creator" content="@MetaviceSwap" />
        <meta key="og:type" property="og:type" content="website" />
        <meta key="og:site_name" property="og:site_name" content="Metavice App" />
